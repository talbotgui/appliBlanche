 ...
 */
@Configuration
public class ClientJsonBatch extends AbstractBatch {

	public static final String NOM_JOB = "importclientjson";
	...
	public ItemReader<LigneCsvImportClient> creer1Source() {
		...
		final ClientJsonLineMapper lineMapper = new ClientJsonLineMapper();
		lineMapper.setDelegate(new JsonLineMapper());

		final FlatFileItemReader<LigneCsvImportClient> reader = new FlatFileItemReader<>();
		reader.setResource(super.creerRessource(this.cheminSource));
