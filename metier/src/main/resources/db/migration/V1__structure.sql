...
create table reservation (id bigint GENERATED BY DEFAULT AS IDENTITY, client varchar(255), etat_courant integer, date_debut date, date_fin date, chambre_id bigint, formule_id bigint, primary key (id));
