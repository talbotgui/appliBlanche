...
create table libelle (id bigint GENERATED ALWAYS AS IDENTITY, clef varchar(255), langue varchar(255), libelle varchar(255), primary key (id));
create table chambre (id bigint GENERATED ALWAYS AS IDENTITY, nom varchar(255), primary key (id));
create table consommation (id bigint GENERATED ALWAYS AS IDENTITY, date_creation date, prix_paye DOUBLE PRECISION, quantite integer, produit_id bigint, reservation_id bigint, primary key (id));
create table produit (id bigint GENERATED ALWAYS AS IDENTITY, couleur varchar(255), nom varchar(255), prix DOUBLE PRECISION, primary key (id));
create table reservation (id bigint GENERATED ALWAYS AS IDENTITY, client varchar(255), etat_courant integer, date_debut date, date_fin date, chambre_id bigint, formule_id bigint, primary key (id));
...
create table formule (id bigint GENERATED ALWAYS AS IDENTITY, nom varchar(255), prix_par_nuit DOUBLE PRECISION, primary key (id));
create table option_reservee (reservation_id bigint GENERATED ALWAYS AS IDENTITY, option_id bigint, primary key (option_id, reservation_id));
create table option_reservation (id bigint GENERATED ALWAYS AS IDENTITY, nom varchar(255), par_nuit boolean, par_personne boolean, prix DOUBLE PRECISION, primary key (id));
