...
create table formule (id bigint not null, nom varchar(255), prix_par_nuit DOUBLE PRECISION, primary key (id));
...
create table option_reservation (id bigint not null, nom varchar(255), par_nuit boolean, par_personne boolean, prix DOUBLE PRECISION, primary key (id));
