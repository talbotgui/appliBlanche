...
create table formule (id bigint not null, nom varchar(255), prix_par_nuit double, primary key (id));
...
create table option_reservation (id bigint not null, nom varchar(255), par_nuit boolean, par_personne boolean, prix double, primary key (id));
