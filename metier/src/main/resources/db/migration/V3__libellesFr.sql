...
insert into LIBELLE (clef, libelle, langue) values ('RESERVATION_DEJA_EXISTANTE', 'Une reservation existe déjà à ces dates', 'fr');
insert into LIBELLE (clef, libelle, langue) values ('SUPPRESSION_IMPOSSIBLE_OBJETS_LIES', 'Suppression impossible car un ou plusieurs objets de type ''{{0}}'' sont liés.', 'fr');
insert into LIBELLE (clef, libelle, langue) values ('TRANSITION_ETAT_IMPOSSIBLE', 'Impossible de passer de l''état ''{{0}}'' à l''état ''{{1}}''.', 'fr');
insert into LIBELLE (clef, libelle, langue) values ('RESERVATION_DATES_INCOHERENTES', 'Les dates de début et fin de cette réservation ne sont pas cohérentes.', 'fr');
-- Page de réservation
