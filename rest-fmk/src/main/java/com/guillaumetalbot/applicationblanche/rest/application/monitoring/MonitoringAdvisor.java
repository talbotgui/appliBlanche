package com.guillaumetalbot.applicationblanche.rest.application.monitoring;
...
public class MonitoringAdvisor extends AbstractPointcutAdvisor {
	...
	private final transient StaticMethodMatcherPointcut pointcut = new StaticMethodMatcherPointcut() {
		...
		public boolean matches(final Method method, final Class<?> targetClass) {
			return targetClass.isAnnotationPresent(RestController.class) || targetClass.isAnnotationPresent(Service.class)
