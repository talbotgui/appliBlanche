...
export default class Menu extends Vue {
    ...
    public mounted() {
        ...
        pagesDuModule.push(new PageApplicative('menu_role', 'users', 'roleEtRessource.listerRoles', '/administration-roles'));
        ...
        // Menu CONSOMMATION
        pagesDuModule = [];
        pagesDuModule.push(new PageApplicative('menu_consommation', 'wine-bottle', 'reservation.rechercherConsommationsDuneReservation', '/consommation'));
